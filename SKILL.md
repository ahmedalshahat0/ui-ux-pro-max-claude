...
The search script is bundled inside this skill. Run it from the skill directory using `python scripts/search.py`; do not assume the project directory contains the script:
